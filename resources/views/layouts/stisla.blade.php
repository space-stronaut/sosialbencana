              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    @can('master')
                        ...
                        <li><a class="nav-link" href="{{ route('kategori.index') }}">Kategori Bencana</a></li>
                        <li><a class="nav-link" href="{{ route('bencana.index') }}">Bencana</a></li>
                        <li><a class="nav-link" href="{{ route('user.index') }}">User</a></li>
                        <li><a class="nav-link" href="{{ route('provinsi.index') }}">Provinsi</a></li>
                        <li><a class="nav-link" href="{{ route('kota.index') }}">Kota</a></li>
                        <li><a class="nav-link" href="{{ route('kecamatan.index') }}">Kecamatan</a></li>
                    @endcan
                    <li><a class="nav-link" href="{{ route('laporan.index') }}">Laporan</a></li>
                </ul>
              </li>
